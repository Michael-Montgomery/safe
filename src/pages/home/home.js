...
export default function Home() {
    ...
    const [episodes, setEpisodes] = useState(videos.slice(0, 12));
    ...
    useEffect(() => {
        ...
        const fetchEpisodes = async () => {
            ...
            try {
                const response = await axios.get(`https://www.googleapis.com/youtube/v3/search?key=${process.env.REACT_APP_YOUTUBE_API_KEY}&channelId=${process.env.REACT_APP_YOUTUBE_CHANNEL_ID}&part=snippet,id&order=date&maxResults=12`);
            ...
            <div className="home">
                ...
                <div className='contact-wrapper'>
                    <form>
                        ...
                        <input type='text' placeholder='Your name...' maxLength={40} required /><br></br>
                        <input type='text' placeholder='Your email address...' maxLength={40} required /><br></br>
                        <textarea placeholder='Your message...' maxLength={500} required></textarea><br></br>
                        <button>Send</button>
                    </form>
